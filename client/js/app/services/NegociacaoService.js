...
System.register(['./HttpService', './ConnectionFactory', '../dao/NegociacaoDao', '../models/Negociacao'], function (_export, _context) {
    ...
    var HttpService, ConnectionFactory, NegociacaoDao, Negociacao, _createClass, NegociacaoService, NegociacaoServiceOutro;
    ...
    return {
        ...
        execute: function () {
            ...
            NegociacaoServiceOutro = function () {
                function NegociacaoServiceOutro() {
                    _classCallCheck(this, NegociacaoServiceOutro);

                    this._http = new HttpService();
                }

                _createClass(NegociacaoServiceOutro, [{
                    key: 'obterNegociacoesDaSemana',
                    value: function obterNegociacoesDaSemana() {
